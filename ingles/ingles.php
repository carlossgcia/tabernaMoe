        ...
        <div class="contenido">
            ...
            <nav class="item item2 navbar navbar-expand-lg navbar-light  menu align-items-center">
                ...
                <ul class="navbar-nav fs-4">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#reservaForm">Book a table</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../admin.php">Admin</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../galeria.php">Galery</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../index.php"><img src="../img/españa.jpg" alt="" class="img"></a>
                    </li>
                </ul>
    ...
    <main>
                        ...
                        <div class="col-12 col-md-6 col-lg-3  mt-2 d-flex align-items-strech">
                            <div class="card" style="width: 100%;">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">
                                        <?php echo $fila["descripcion_ingles"]; ?>
                                    </p>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <h2 style="text-align: center;" class="mt-4">Book for a table</h2>
                <div class="col-8">
                    <form id="reservaForm" class="formulario mt-4" action="reserva.php" method="post">
                        ...
                        <div class="mb-3">
                            <label for="fecha" class="form-label">Date of book:</label>
                            <input type="date" id="fecha" name="fecha" class="form-control" required>
                        </div>

                        <div class="mb-3">
                            <label for="hora" class="form-label">Hour of book:</label>
                            <select id="hora" name="hora" class="form-control" required>
                                <option value="">Selecct an hour</option>
                        ...
                        <button type="submit" class="btn btn-primary mb-3 btnReservar">Book a table</button>
                    </form>
                </div>
            </div>
        </div>
